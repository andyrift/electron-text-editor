...
export const hrDOM: readonly [string, ...any] = [
  "hr", { class: "my-2 py-2 border-none" }, [
    "div", { class: "border-gray-400 border-t"}
  ]
]

export const blockquoteDOM: readonly [string, ...any] = [
  "blockquote", { class: "py-0.5 pl-4 border-l-2 border-gray-300" }, 0
]
