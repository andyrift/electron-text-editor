<template>
  <div ref="relative" class="max-w-3xl mx-auto relative" @contextmenu="contextmenu">
    ...
    <div v-if="false" v-for="rect in rectangles" :style="{ top: rect.top + 'px', left: rect.left - 20 + 'px', width: rect.width + 20 + 'px', height: rect.height + 'px' }" 
